...
exports.seed = async function(knex) {
  ...
  await knex('antenna').insert([
    {id: 1, server_id: 1, team_id: 1, unit: 1, operational: true, target_id: 1, locked: true, band: 'C', offset: 400, hpa: false, loopback: true},
    {id: 2, server_id: 1, team_id: 1, unit: 2, operational: true, target_id: 1, locked: true, band: 'C', offset: 400, hpa: false, loopback: true},
    {id: 3, server_id: 1, team_id: 2, unit: 1, operational: true, target_id: 1, locked: true, band: 'C', offset: 400, hpa: false, loopback: true},
    {id: 4, server_id: 1, team_id: 2, unit: 2, operational: true, target_id: 1, locked: true, band: 'C', offset: 400, hpa: false, loopback: true},
